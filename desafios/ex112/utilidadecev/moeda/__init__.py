...
def resumo(n=0, taxa=0, taxa2=0):
    ...
    print(f'{"DOBRO DO PREÇO:":<20}{moeda(dobro(n, True))}')
    print(f'{"METADE DO PREÇO:":<20}{moeda(metade(n, True))}')
    print(f'{taxa}{"%DE AUMENTO:":<17} {moeda(aumentar(n, taxa, True))}')
    print(f'{taxa2}{"%DE REDUÇÃO:":<18}{moeda(diminuir(n, taxa2, True))}')
    print('-'*30)
